...
export default function SignUpScreen() {
  ...
  const handlePostData = async () => {
    ...
    try {
      const response = await axios.post('http://192.168.29.242:3500/Adminstore/delivery/Register', data, {
        headers: {
      ...
      if (response.status === 200) {
        try {
          ...
          const otpResponse = await axios.post('http://192.168.29.242:3500/Adminstore/delivery/generate-otp', {
            phonenumber: mobileNumber
          });
      ...
      if (errorMessage === "Delivery person already exists") {
        Alert.alert(
          'Account Exists',
  ...
  const verifyOTP = async (otp) => {
    try {
      const response = await axios.post('http://192.168.29.242:3500/Adminstore/delivery/verify-otp', {
        phonenumber: mobileNumber,
        otp: otp.join('')
      });
